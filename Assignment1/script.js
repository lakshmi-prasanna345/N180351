...
let img_a = ["image1 (1).jpg","image1 (2).jpg","image1 (3).jpg"]
let i=0;
function slideprev() {
    if(i==0)
        i=2;
    ...
    if(i==0){
        ...
        document.getElementById("i2").style.backgroundColor="black";
    }
    else if(i==1){
        document.getElementById("i2").style.backgroundColor="blue";
        document.getElementById("i3").style.backgroundColor="black";
    }
    else{
...
function currentSlide(k){
    ...
    if(k==0){
        document.getElementById("i1").style.backgroundColor="cyan";
        document.getElementById("i2").style.backgroundColor="black";
        document.getElementById("i3").style.backgroundColor="black";
    }
    else if(k==1){
        document.getElementById("i1").style.backgroundColor="black";
        document.getElementById("i2").style.backgroundColor="cyan";
        document.getElementById("i3").style.backgroundColor="black";
    }
    else{
        document.getElementById("i1").style.backgroundColor="black";
        document.getElementById("i2").style.backgroundColor="black";
        document.getElementById("i3").style.backgroundColor="cyan";
    }
}
...
function FacultyValid(){
    ...
    if(pattern.test(a)){
        ...
        document.getElementById("fid-val").style.border = "3px solid orange";
        return false;
    }
}
...
function loginValid(){
    if(document.getElementById("lid-val").value==="Naveen" && document.getElementById("21").value==="Naveen@1729")
...
function scroll(){
    var l=document.getElementById('mainsearch2').firstElementChild;
    l.remove();
    document.getElementById('mainsearch2').append(l);
}
